...
import { LayoutDashboard, Shield, User, Music, Rocket, Bell, Inbox, Film, ClipboardList } from 'lucide-react';
...
export default function DashboardNav({ role, isProducer, displayName, email, profileSlug }: DashboardNavProps) {
  ...
  const tabs = [
    ...
    // Engineer tab REMOVED in the 2026-09 media pivot — studio sessions are
    // gone, so there is no engineer work surface (/engineer redirects to
    // /dashboard). Media Team is the staff surface now.
