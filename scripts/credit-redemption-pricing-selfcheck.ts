...
// 1-hour free-hour redemptions: the credit covers the FULL single-hour base
// (6000), so only surcharges remain (Cole's rule — no leftover $10).
...
// 2. 1hr, 11pm, NOT same-day → total 7000, discount 6000, payNow 1000 (late fee), remainder 0.
check(
...
// 3. 1hr, 2pm, not same-day, 1 guest (free) → total 6000, discount 6000, payNow 0
//    (fully free — instant confirm, no Stripe).
check(
